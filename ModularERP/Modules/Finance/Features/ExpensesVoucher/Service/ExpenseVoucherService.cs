    ...
    public class ExpenseVoucherService : IExpenseVoucherService
    {
        ...
        public async Task<bool> ValidateWalletPermissionAsync(Guid walletId, string walletType, Guid userId, string operation)
        {
            if (walletType == "Treasury")
            {
                ...
                var acl = operation == "Withdraw" ? treasury.WithdrawAcl : treasury.DepositAcl;
            ...
            if (walletType == "BankAccount")
            {
                ...
                var acl = operation == "Withdraw" ? bankAccount.WithdrawAcl : bankAccount.DepositAcl;
                return acl == "Everyone"; // Simplified for now
            }
        ...
        public async Task<bool> IsCategoryValidAsync(Guid categoryId)
        {
            ...
            return account != null && account.Type == AccountType.Expense && account.IsLeaf;
        }
        ...
        {
            var year = date.Year;
            var prefix = type == VoucherType.Expense ? "EXP" : "INC";
