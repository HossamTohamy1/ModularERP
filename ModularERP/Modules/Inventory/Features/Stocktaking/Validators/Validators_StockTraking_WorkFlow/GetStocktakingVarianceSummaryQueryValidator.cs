...
{
    public class GetStocktakingVarianceSummaryQueryValidator : AbstractValidator<GetStocktakingVarianceSummaryQuery>
    {
        public GetStocktakingVarianceSummaryQueryValidator()
        {
