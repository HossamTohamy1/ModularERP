...
{
    public class GetBarcodeSettingByIdHandler : IRequestHandler<GetBarcodeSettingByIdQuery, ResponseViewModel<BarcodeSettingsDto>>
    {
        private readonly IGeneralRepository<BarcodeSettings> _repository;
        private readonly IMapper _mapper;

        public GetBarcodeSettingByIdHandler(IGeneralRepository<BarcodeSettings> repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }

        public async Task<ResponseViewModel<BarcodeSettingsDto>> Handle(GetBarcodeSettingByIdQuery request, CancellationToken cancellationToken)
        {
