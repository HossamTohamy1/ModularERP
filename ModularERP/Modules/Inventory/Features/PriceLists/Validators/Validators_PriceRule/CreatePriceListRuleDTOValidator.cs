...
{
    public class CreatePriceListRuleDTOValidator : AbstractValidator<CreatePriceListRuleDTO>
    {
        public CreatePriceListRuleDTOValidator()
        {
            ...
            // Value is required for certain rule types
            RuleFor(x => x.Value)
                .NotNull()
